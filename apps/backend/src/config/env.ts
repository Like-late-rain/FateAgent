...
const DEFAULT_SUPABASE_SERVICE_KEY = process.env.SUPABASE_SERVICE_KEY;
...
export const ENV = {
  ...
  supabaseUrl: getRequiredEnv(DEFAULT_SUPABASE_URL, 'SUPABASE_URL'),
  supabaseServiceKey: getRequiredEnv(DEFAULT_SUPABASE_SERVICE_KEY, 'SUPABASE_SERVICE_KEY'),
};
